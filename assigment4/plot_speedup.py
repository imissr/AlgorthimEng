...
plt.figure()
line1, = plt.plot(df_fixed["threads"], df_fixed["speedup_minmax"],
                  marker="o", label="min_max_quicksort")
line2, = plt.plot(df_fixed["threads"], df_fixed["speedup_gnu"],
                  marker="o", label="__gnu_parallel::sort")
plt.axhline(1.0, linestyle="--")  # speedup 1 = same as std::sort
...
plt.figure()
line1, = plt.plot(df_all["N"], df_all["speedup_minmax"],
                  marker="o", label="min_max_quicksort")
line2, = plt.plot(df_all["N"], df_all["speedup_gnu"],
                  marker="o", label="__gnu_parallel::sort")
